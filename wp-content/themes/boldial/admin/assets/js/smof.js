    ...
    if ( import_btn.length > 0 ) {
        import_btn.click( function(e){
            ...
            $.ajax({
                ...
                data:
                {
                    action: 'ishyoboy_ajax_demo_import',
                ...
                success: function( response )
                {
                    ...
                    if (
                        ...
                        response.match( 'ish_pages_set' ) &&
                        response.match( 'ish_menus_set' ) &&
                        response.match( 'ish_widgets_set' ) &&
                        response.match( 'ish_permalinks_set' ) )
                    {
                        jQuery('.import-box .import-started-message').fadeOut(300, function(){
